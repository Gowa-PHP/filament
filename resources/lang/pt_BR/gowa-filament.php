...
return [
    ...
    'fields' => [
        'section_title' => 'Informações da Instância',
        'section_desc' => 'Configure os dados de identificação do dispositivo WhatsApp.',
        'name' => 'Nome da Instância',
        'name_placeholder' => 'Ex: Atendimento Vendas',
        'name_helper' => 'Nome amigável para identificação rápida.',
        'device_id' => 'ID do Dispositivo',
        'device_id_placeholder' => 'Ex: device_vendas_01',
        'device_id_helper' => 'Identificador único para a API GOWA.',
