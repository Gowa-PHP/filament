...
return [
    ...
    'fields' => [
        'section_title' => 'Instance Information',
        'section_desc' => 'Configure identification details for the WhatsApp device.',
        'name' => 'Instance Name',
        'name_placeholder' => 'e.g. Sales WhatsApp',
        'name_helper' => 'Friendly name for quick identification.',
        'device_id' => 'Device ID',
        'device_id_placeholder' => 'e.g. device_sales_01',
        'device_id_helper' => 'Unique device identifier for GOWA API.',
        'phone' => 'Phone Number',
