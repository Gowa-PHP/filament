...
return [
    ...
    'messaging' => [
        ...
        'subheading' => 'Compose and send different message types (Text, Media, Contact, Location, Link, Poll, and Presence).',
        'recipient_section' => '1. Recipient Configuration',
        'composer_section' => '2. Message Composition',
        'curl_heading' => 'Equivalent cURL Command',
        'curl_desc' => 'Use this cURL command to reproduce the HTTP request in scripts or terminal.',
    ],
];
